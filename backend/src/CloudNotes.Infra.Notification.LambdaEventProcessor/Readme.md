...
Execute unit tests
```
    cd "CloudNotes.Infra.Notification.LambdaEventProcessor/test/CloudNotes.Infra.Notification.LambdaEventProcessor.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CloudNotes.Infra.Notification.LambdaEventProcessor/src/CloudNotes.Infra.Notification.LambdaEventProcessor"
